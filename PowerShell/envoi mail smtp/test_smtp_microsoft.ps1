...
Send-MailMessage -From $email -To "SAISIR@VOTREADRESSE.MAIL" -Subject "Test Email" -Body "Test SMTP authentifie microsoft 365" -SmtpServer smtp.office365.com -Credential $identifiants -UseSsl -Port 587 
